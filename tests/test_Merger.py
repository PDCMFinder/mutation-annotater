...
class TestFilter(TestCase):
    ...
    def test_GivenTwoMatchingColumns_WhenRowBuilderIsCalled_Then_ReturnCorrectlyBuiltRow(self):
        ...
        ncbiRow = {'Feature_type': 'Transcript', 'Extra': 'IMPACT=HIGH;STRAND=-1;VARIANT_'
                   ...
                   '#Uploaded_variation': '19_10491677_T/-', 'cDNA_position': '1388', 'Feature': ncbiFeature, 'Codons': 'Atg/tg', 'Existing_variation': '-', 'Location': '19:10491677', 'CDS_position': '1225',
                   'Protein_position': '409', 'Consequence': 'frameshift_variant', 'Allele': '-', 'Gene': ncbiGene, 'Amino_acids': 'M/X'}
        ...
        tsvInputRow =  {'alt_allele': '-', 'read_depth': '11572', 'ensembl_gene_id': '', 'rs_id_Variant': '', 'Platform': 'Targeted NGS', 'ucsc_gene_id': '',
                          'ref_allele': 'T', 'chromosome': '19', 'ncbi_gene_id': '', 'nucleotide_change': '1225delA', 'hgnc_symbol': 'KEAP1', 'consequence': 'stop gain', 'Allele_frequency': '96,47', 'Passage': '27', 'amino_acid_change': 'M409X', 'Model_ID': 'LCF16',
